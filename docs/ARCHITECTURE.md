...
```
   ...
   │  TAXONOMY LOOKUP   │      across the seven audit domains. In later phases
...
### 2. Pitfall taxonomy
The curated catalog of pitfall rules, organized by the seven audit domains from the book. Each rule is a structured object (see [PITFALL_TAXONOMY.md](PITFALL_TAXONOMY.md)). The taxonomy is the project's center of gravity — it's what makes the audits specific and grounded rather than generic.
